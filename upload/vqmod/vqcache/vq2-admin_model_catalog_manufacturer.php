...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', config_background_image_position = '" . $this->db->escape($data['config_background_image_position']) . "', config_background_image = '" . $this->db->escape($data['config_background_image']) . "', sort_order = '" . (int)$data['sort_order'] . "'");
	...
	public function editManufacturer($manufacturer_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', config_background_image_position = '" . $this->db->escape($data['config_background_image_position']) . "', config_background_image = '" . $this->db->escape($data['config_background_image']) . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
