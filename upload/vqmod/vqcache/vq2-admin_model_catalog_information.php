...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		...
		foreach ($data['information_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "information_description SET information_id = '" . (int)$information_id . "', language_id = '" . (int)$language_id . "', title = '" . $this->db->escape($value['title']) . "', description = '" . $this->db->escape($value['description']) . "', meta_title = '" . $this->db->escape($value['meta_title']) . "', config_background_image_position = '" . $this->db->escape($data['config_background_image_position']) . "', config_background_image = '" . $this->db->escape($data['config_background_image']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "'");
		}
...
'config_background_image_position'            => $result['config_background_image_position'],
                'config_background_image'            => $result['config_background_image'],
				'title'            => $result['title'],
